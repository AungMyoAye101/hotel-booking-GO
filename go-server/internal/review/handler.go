...
func (h *Handler) CreateReview(c echo.Context) error {
	...
	return response.SuccessResponse(c, http.StatusCreated, "review created", r)
}
...
func (h *Handler) GetReviewByID(c echo.Context) error {
	...
	return response.SuccessResponse(c, http.StatusOK, "review fetched", r)
}
...
func (h *Handler) DeleteReview(c echo.Context) error {
	...
	return response.SuccessResponse(c, http.StatusOK, "review deleted", nil)
}
